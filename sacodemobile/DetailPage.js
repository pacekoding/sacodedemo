...
const Header = () => {
  return (
    <View style={{padding:16, backgroundColor: "#abc4ff"}}>
...
const DetailPage = () => {
  ...
  if (members.length == 0) {
    return <SafeAreaView style={{flex: 1, backgroundColor: "#809bce"}}>
          ...
          members.map((member) => {
            ...
            return <View 
              ...
              style={{
                ...
                <Text style={{...styles.cardText, fontSize: 18}}>{member.joinDate}</Text>
            </View>
          })
        }
      </ScrollView>
